...
import com.rp.course.sec09.helper.bookstore.Book;
import com.rp.course.sec09.helper.bookstore.BookOrder;
...
public class Lec04AssertTest {
    ...
    private Mono<BookOrder> getBookOrderMono() {
        Supplier<Book> bookCreate = () -> new Book(Util.faker().book().title(), Util.faker().book().genre());
