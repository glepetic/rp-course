...
public class Lec01BufferTimeout {
    ...
    public static void main(String[] args) {
        ...
        highEventStream()
                ...
                .subscribe(ScratchUtil.subscriber("Every 2 Seconds No Limit"));

        // double condition, MAX 5 elements, but emits onNext if it didn't gather enough in the time given
        highEventStream()
                .bufferTimeout(5, Duration.ofSeconds(2))
                .subscribe(ScratchUtil.subscriber("Every 2 Seconds With Limit"));

        lowEventStream()
                .bufferTimeout(5, Duration.ofSeconds(2))
                .subscribe(ScratchUtil.subscriber("Low Event Stream"));
