...
public class Lec01SinkOne {
    ...
    public static void main(String[] args) {
        ...
        mono.subscribe(ScratchUtil.subscriber("Value1Sub"));
        mono.subscribe(ScratchUtil.subscriber("Value2Sub"));
        ...
        monoRetry.subscribe(ScratchUtil.subscriber("RetrySub"));
