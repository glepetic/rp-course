    ...
    public static void main(String[] args) {
        ...
        */
        ...
        Flux.range(1, 10)
                ...
                .log()
                .subscribe(ScratchUtil.subscriber("Unbounded"));

        Flux.range(1, 500)
                .log()
                // requests 100, requests 75 more when it finished processing 75
                .limitRate(100)
                .subscribe(ScratchUtil.subscriber("SubscriberA"));

        Flux.range(1, 1000)
                .log()
                // requests 200, requests 50 more when it finished processing 50
                .limitRate(200, 50)
                .subscribe(ScratchUtil.subscriber("SubscriberB"));

        Flux.range(1, 500)
                .log()
                // requests 100, requests highTide always
                .limitRate(100, 0)
                .subscribe(ScratchUtil.subscriber("SubscriberC"));
        ...
        Flux.range(1, 1000)
                ...
                .subscribe(ScratchUtil.subscriber("PercentageSubscriber"));
